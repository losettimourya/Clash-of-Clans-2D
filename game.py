...
from characters import spawnBarbarian, move_barbarians, spawnArcher, spawnstealthArcher, move_stealtharchers, move_archers, spawnDragon, move_dragons, spawnBalloon, move_balloons, spawnHealer, move_healers, clearTroops
...
os.system('clear')
printMap(V)
Phealth(showKingHealth(King.health, King.max_health))
